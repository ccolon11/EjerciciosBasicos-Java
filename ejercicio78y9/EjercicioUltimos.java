package com.ejercicios.ejercicio78y9;
...
class EjercicioUltimos {
    ...
    public static class ArrayUnidimensional {
        ...
        public static void main(String[] args) {
            ...
            String [] textos= {"Azul", "Verde", "Turquesa"};
    ...
    public static class EjercicioVector {
        ...
        public static void main(String[] args) {
            ...
            vector.add("Playa(1°)");
            vector.add("Montaña(2°)");
            vector.add("Desierto(3°)");
            vector.add("Safari(4°)");
            vector.add("Zoologico(5°)");
